...
static Model *getModel()
{
    ...
    Vertex *v1 = [[Vertex alloc] initWithX:0.0f:1.0f:0.0f];
    Vertex *v2 = [[Vertex alloc] initWithX:1.0f:1.0f:0.0f];
    Vertex *v3 = [[Vertex alloc] initWithX:0.0f:2.0f:0.0f];
    ...
    //SinglePoint *point = [[SinglePoint alloc] initWithVertex:v1];
    Triangle *triangle5 = [[Triangle alloc] initWithVertices:v1:v2:v3];
    ...
    [triangle5 setColor:0.0f:1.0f:1.0f];
    ...
    [component1 setTriangleCount:2];
    [component1 setTriangle:0:triangle1];
    [component1 setTriangle:1:triangle5];
    //[component1 setPointCount:1];
    //[component1 setPoint:0:point];
...
-(void) setUpOpenGL
{
    ...
    //glDepthMask(GL_TRUE); // GL_TRUE, GL_FALSE :Enables writing to the depth buffer
    glDepthFunc(GL_LESS);  // GL_LESS, GL_NEVER, GL_ALWAYS, GL_GREATER, GL_EQUAL
    glClearDepth(5000.0);
